...
export const dictionary = {
  nav: {
    ...
    sell: { es: "Vender", en: "Sell", fr: "Vendre", de: "Verkaufen" },
  ...
  agents: {
    ...
    dayana: {
      ...
      bio: {
        es: "Dayana es cofundadora de EllaDay Homes. Creció en La Fortuna y acompaña a cada cliente con cercanía y honestidad, con un conocimiento real de la zona en cada paso del proceso.",
        en: "Dayana is a co-founder of EllaDay Homes. She grew up in La Fortuna and supports every client with closeness and honesty, bringing real local knowledge to each step of the process.",
        fr: "Dayana est cofondatrice d'EllaDay Homes. Elle a grandi à La Fortuna et accompagne chaque client avec proximité et honnêteté, avec une vraie connaissance de la région à chaque étape du processus.",
        de: "Dayana ist Mitgründerin von EllaDay Homes. Sie ist in La Fortuna aufgewachsen und begleitet jeden Kunden mit Nähe und Ehrlichkeit – mit echtem Wissen über die Region in jedem Schritt des Prozesses.",
      },
    },
    ella: {
      role: {
      ...
      bio: {
        es: "Ella es cofundadora de EllaDay Homes. Vive y trabaja en La Fortuna, y se asegura de que comprar o invertir aquí sea un proceso claro, tranquilo y de confianza.",
        en: "Ella is a co-founder of EllaDay Homes. She lives and works in La Fortuna and makes sure that buying or investing here is a clear, calm and trustworthy process.",
        fr: "Ella est cofondatrice d'EllaDay Homes. Elle vit et travaille à La Fortuna et veille à ce qu'acheter ou investir ici soit un processus clair, serein et de confiance.",
        de: "Ella ist Mitgründerin von EllaDay Homes. Sie lebt und arbeitet in La Fortuna und sorgt dafür, dass Kaufen oder Investieren hier ein klarer, ruhiger und vertrauensvoller Prozess ist.",
      },
    },
  },
  featured: {
